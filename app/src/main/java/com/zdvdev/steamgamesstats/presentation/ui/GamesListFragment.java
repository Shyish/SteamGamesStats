...
import com.zdvdev.steamgamesstats.presentation.ui.adapter.GamesAdapter;
...
public class GamesListFragment extends NavigableFragment {
	...
	@BindView(R.id.games_list) ListView mGamesList;
	@BindView(R.id.games_list_total) TextView mGamesListTotal;

	public static Bundle buildParams(ArrayList<UsersHoursPerGame> commonGames) {
		Bundle params = new Bundle();
		params.putSerializable(KEY_GAMES, commonGames);
		return params;
	}
	...
	@Override public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		if (args != null && args.containsKey(KEY_GAMES)) {
			ArrayList<UsersHoursPerGame> gamesList = (ArrayList<UsersHoursPerGame>) args.getSerializable(KEY_GAMES);
	...
	private static final Comparator<UsersHoursPerGame> gameNameComparator = new Comparator<UsersHoursPerGame>() {
		@Override public int compare(UsersHoursPerGame lhs, UsersHoursPerGame rhs) {
			return lhs.game.getName().compareTo(rhs.game.getName());
		}
	};

	private static final Comparator<UsersHoursPerGame> gamePlayTimeComparator = new Comparator<UsersHoursPerGame>() {
		@Override public int compare(UsersHoursPerGame lhs, UsersHoursPerGame rhs) {
			// Descending order
